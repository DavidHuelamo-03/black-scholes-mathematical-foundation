...
* **Risk-Neutral Valuation:** Applying **Girsanov's Theorem** to perform a change of probability measure (from physical $\mathbb{P}$ to risk-neutral $\mathbb{Q}$), effectively neutralizing market risk.
...
## About Compilation
To compile the `.tex` file locally, ensure you have a standard LaTeX distribution installed (like TeX Live or MiKTeX) along with the `biber` backend for the bibliography.
